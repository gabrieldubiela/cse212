...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: line 16 from PersonQueue.cs - changed _queue.Insert(0, person); to _queue.Add(person);
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Did not enqueue when have 0 turns of less. Added lines 48 to 51 in TakingTurnsQueue.cs by adding an else if block to check for turns <= 0 and re-enqueue the person.
