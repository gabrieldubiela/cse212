...
public class LinkedList : IEnumerable<int>
{
    ...
    public void Remove(int value)
    {
        ...
        // use a loop to find the first node that contains 'value'
        Node? curr = _head;
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                ...
                // Exit after removing the first occurrence
                return; 
            }
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        // use a loop to find the nodes that contains 'value'
        Node? curr = _head;
        while (curr is not null)
        {
    ...
    public IEnumerable Reverse()
    {
        ...
        // Use a loop to get the numbers from tail to head
        Node? curr = _tail;
        while (curr is not null)
        {
            yield return curr.Data; // Provide (yield) each item to the user
